...
class usuario
{
    private: //Atributos de la clase usuario
        ...
        int mIndice=0; //representa la ultima posicion del documento del usuario que ha ingresado
    ...
    public: //Metodos de la clase usuario
        ...
        void Registar();                     //Le permite al administrador añadir un nuevo usuario, escribe al
                                             //final del txt la nueva informacion

        string decotwo(string cadena_codificada); //decodificador

        string codtwo(string cadena_Binaria);     //codificador 2do metodo,2do metodo recibe como parametro la cadena(string)
                                                  //codificada ,partiendo la cadena en grupos de 4 bits
                                                  //y desplaza dentro de cada grupo cada bit una posicion
